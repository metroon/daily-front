...
export class CustomizerService {
  constructor(private sessionStorageService: SessionStorageService) {
    ...
    var color = sessionStorageService.getItem('color') || this.data.color.color;
    var layoutVersion =
      sessionStorageService.getItem('layoutVersion') ||
      this.data.color.layout_version;
    if (color) {
  ...
  setLayout(layout) {
    ...
    this.sessionStorageService.setItem('layout_type', layout);
  }
  ...
  setColor(color) {
    ...
    this.sessionStorageService.setItem('color', this.data.color.color);
    this.sessionStorageService.setItem(
      'primary_color',
      this.data.color.primary_color
    );
    this.sessionStorageService.setItem(
      'secondary_color',
      this.data.color.secondary_color
    );
